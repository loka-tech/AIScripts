...
# Usage: python gptq_test.py <model folder> --use_slow --use_safetensors --use_triton --trust_remote_code --bits 4 --group_size 128 --desc_act --device cuda:0 --min_new_tokens 512 --max_new_tokens 512
# Example: python gptq_test.py gpt2_fp16 --use_slow --use_safetensors --use_triton --trust_remote_code --bits 4 --group_size 128 --desc_act --device cuda:0 --min_new_tokens 512 --max_new_tokens 512
